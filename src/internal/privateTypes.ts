import { AsyncHookResult, DeviceType, LocationProviderInfo, PowerState } from './types';
...
export interface MethodsExposedFromNative {
...
export interface DeviceInfoNativeMethods extends MethodsExposedFromNative {
...
export interface DeviceInfoModule extends MethodsExposedFromNative {
